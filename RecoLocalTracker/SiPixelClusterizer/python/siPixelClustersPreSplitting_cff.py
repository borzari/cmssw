...
# These produce pixelDigiErrors in Alpaka
...
siPixelDigisSoACUDA = _siPixelDigisSoAFromCUDA.clone(
    src = "siPixelClustersPreSplittingCUDA"
)

siPixelDigiErrorsSoACUDA = _siPixelDigiErrorsSoAFromCUDA.clone(
    src = "siPixelClustersPreSplittingCUDA"
)

siPixelDigiErrorsCUDA = _siPixelDigiErrorsFromSoA.clone(
    digiErrorSoASrc = "siPixelDigiErrorsSoACUDA"
)
...
alpakaCUDAValidationPixel.toModify(siPixelDigis,
    cuda = cms.EDAlias(
        siPixelDigiErrorsCUDA = cms.VPSet(
