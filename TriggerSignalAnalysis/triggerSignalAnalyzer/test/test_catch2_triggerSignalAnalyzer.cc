...
static constexpr auto s_tag = "[triggerSignalAnalyzer]";

TEST_CASE("Standard checks of triggerSignalAnalyzer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("triggerSignalAnalyzer"
