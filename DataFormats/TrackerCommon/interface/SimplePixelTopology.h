#ifndef DataFormats_TrackerCommon_SimplePixelTopology_h
#define DataFormats_TrackerCommon_SimplePixelTopology_h
...
namespace pixelTopology {
  ...
  struct Phase2 {
#ifdef GPU_SMALL_EVENTS
    static constexpr uint32_t maxNumberOfHits = 24 * 1024;
#else
...
#endif  // DataFormats_TrackerCommon_SimplePixelTopology_h
