...
//      printf("hitsModuleStart %d ->%d \n", i, soa.hitsModuleStart().at(28));
  ...
  template void runKernels<pixelTopology::Phase1>(TrackingRecHitAlpakaSoAView<pixelTopology::Phase1>& view, Queue& queue);
  template void runKernels<pixelTopology::Phase2>(TrackingRecHitAlpakaSoAView<pixelTopology::Phase2>& view, Queue& queue);
